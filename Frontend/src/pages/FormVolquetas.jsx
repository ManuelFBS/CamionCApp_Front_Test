...
const FormVolquetas = () => {
  const [formData, setFormData] = useState({
    ...
    totalKilometros: '',
    viajes: [
      { cliente: '', lugarCargue: '', lugarDescargue: '', material: '', cantidad: '', observaciones: '' },
      { cliente: '', lugarCargue: '', lugarDescargue: '', material: '', cantidad: '', observaciones: '' },
      { cliente: '', lugarCargue: '', lugarDescargue: '', material: '', cantidad: '', observaciones: '' },
    ],
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      <h1 className="text-3xl text-gray-600 font-bold text-center mb-6">Control de Transporte de Materiales Volquetas Diario</h1>
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mb-4">
          <label htmlFor="reciboObra" className="block text-gray-700">Recibo de Obra No:</label>
          <input
            type="text"
            id="reciboObra"
            name="reciboObra"
        ...
        <div className="mb-4">
          <label htmlFor="horaSalida" className="block text-gray-700">Hora de Salida:</label>
          <input
            type="time"
            id="horaSalida"
            name="horaSalida"
        ...
        <div className="mb-4">
          <label htmlFor="numeroViajes" className="block text-gray-700">Número de Viajes por Día:</label>
          <input
            type="number"
            id="numeroViajes"
            name="numeroViajes"
        ...
        <div className="mb-4">
          <label htmlFor="kilometrajeInicial" className="block text-gray-700">Kilometraje Inicial Vehículo:</label>
          <input
            type="number"
        ...
        <div className="mb-4">
          <label htmlFor="kilometrajeFinal" className="block text-gray-700">Kilometraje Final Vehículo:</label>
          <input
            type="number"
            id="kilometrajeFinal"
        ...
        <div className="mb-4">
          <label htmlFor="totalKilometros" className="block text-gray-700">Total Kilómetros Recorridos Diario:</label>
          <input
            type="number"
            id="totalKilometros"
        ...
        {formData.viajes.map((viaje, index) => (
          <div key={index} className="border border-gray-300 p-4 mb-4 rounded-md">
            <h3 className="font-semibold mb-2">Viaje {index + 1}</h3>
            <div className="mb-4">
              <label htmlFor={`viajes_${index}_cliente`} className="block text-gray-700">Cliente:</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor={`viajes_${index}_lugarCargue`} className="block text-gray-700">Lugar de Cargue:</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor={`viajes_${index}_lugarDescargue`} className="block text-gray-700">Lugar de Descargue:</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor={`viajes_${index}_material`} className="block text-gray-700">Material o Actividad:</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor={`viajes_${index}_cantidad`} className="block text-gray-700">Cantidad Metros Cúbicos:</label>
              <input
                type="number"
            ...
            <div className="mb-4">
              <label htmlFor={`viajes_${index}_observaciones`} className="block text-gray-700">Observaciones:</label>
              <input
                type="text"
