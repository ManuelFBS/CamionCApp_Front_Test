    ...
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Número de Planilla:</span>
            <span className="text-gray-800">123456</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Valor Anticipo:</span>
            <span className="text-gray-800">$2,000,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Fecha de Inicio:</span>
            <span className="text-gray-800">2024-08-01</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Fecha Final:</span>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-gray-800">Detalles del Flete</h2>
        <table className="w-full border border-gray-300">
          <thead className="bg-gray-200">
            <tr>
              <th className="border border-gray-300 px-4 py-2 text-gray-800">Empresa</th>
              <th className="border border-gray-300 px-4 py-2 text-gray-800"># Manifiesto</th>
              <th className="border border-gray-300 px-4 py-2 text-gray-800">Origen</th>
              <th className="border border-gray-300 px-4 py-2 text-gray-800">Destino</th>
              <th className="border border-gray-300 px-4 py-2 text-gray-800">Valor Flete</th>
              <th className="border border-gray-300 px-4 py-2 text-gray-800">Anticipo</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-gray-300 px-4 py-2 text-gray-800 ">INVERTRANS</td>
              <td className="border border-gray-300 px-4 py-2 text-gray-800">5465465</td>
              <td className="border border-gray-300 px-4 py-2 text-gray-800">PASTO</td>
              <td className="border border-gray-300 px-4 py-2 text-gray-800">CALI</td>
              <td className="border border-gray-300 px-4 py-2 text-gray-800">$5,000,000</td>
              <td className="border border-gray-300 px-4 py-2 text-gray-800">$1,500,000</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-gray-800">Gastos de Viaje</h2>
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">ACPM:</span>
            <span className="text-gray-800">$1,200,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Descargue:</span>
            <span className="text-gray-800">$200,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Cargue:</span>
            <span className="text-gray-800">$100,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Peajes:</span>
            <span className="text-gray-800">$800,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Báscula:</span>
            <span className="text-gray-800">$50,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Despinchada Llanta:</span>
            <span className="text-gray-800">$150,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Pago Fras No 544 Mantenimiento:</span>
            <span className="text-gray-800">$500,000.00</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold w-48 text-gray-800">Lavada General:</span>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex justify-between font-semibold">
          <span className="text-gray-800">Saldo a Favor Empresa y/o Empleado:</span>
