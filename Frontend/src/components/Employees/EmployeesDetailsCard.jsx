    ...
    return (
        ...
        >
            <div className="p-4">
                ...
                <p className="text-gray-700 text-base mb-2">
                    Inicio de Contrato:{' '}
                    <b>{formatDate(employee.fecha_inicio_contrato)}</b>
                </p>
                {employee.fecha_final_contrato && (
                    <p className="text-gray-700 text-base mb-2">
                        Finalización de Contrato:{' '}
                        <b>{formatDate(employee.fecha_final_contrato)}</b>
                    </p>
                )}
                ...
                <hr className="h-1 border-0 bg-gray-400 mb-4" />
                ...
                {hasLicense ? (
                    <>
                        ...
                        <p className="text-gray-700 text-base mb-3">
                            Expedición:{' '}
                            <b>{formatDate(license.date_of_issue)}</b>
                        </p>

                        <p className="text-gray-700 text-base mb-3">
                            Vencimiento:{' '}
                            <b>{formatDate(license.expiration_date)}</b>
                        </p>
                    </>
                ) : (
                    <>
